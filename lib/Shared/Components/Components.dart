...
import 'package:flutter_app_newsv1/Modules/Contacts_screen.dart';
import 'package:flutter_app_newsv1/Shared/style.dart';
...
Widget buildHomeItemProducts(context, model,) => Padding(
  padding: const EdgeInsets.all(20.0),
  child: Container(
    height: 120.0,
    width: 200.0,
